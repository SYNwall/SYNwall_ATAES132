...
// 111012 Tuwuh, added macro for return value
#ifndef EXIT_SUCCESS
...
return_type at_aes_encrypt( const unsigned char in[N_BLOCK],
                         unsigned char out[N_BLOCK],
                         const aes_context ctx[1] );

return_type at_aes_cbc_encrypt( const unsigned char *in,
                         unsigned char *out,
                         int n_block,
